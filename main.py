...
# =====================================================================================
HASHTAGS = {
    "startup": "#استراتژی‌واگرایی‌کارآمد_راه‌اندازی_شد",
    "diagnostic": "#استراتژی_واگرایی_کارآمد_بررسی_سلامت",
    "signal": "#استراتژی‌واگرایی‌کارآمد_سیگنال_جدید",
    "log": "#استراتژی‌واگرایی‌کارآمد_لاگ_دیباگ",
    "alert": "#استراتژی‌واگرایی‌کارآمد_آماده_باش",
    "pivot": "#استراتژی‌واگرایی‌کارآمد_تشکیل_پیوت",
    "target": "#استراتژی‌واگرایی‌کارآمد_تارگت_زد",
    "stop": "#استراتژی‌واگرایی‌کارآمد_استاپ_خورد",
    "daily": "#استراتژی‌واگرایی‌کارآمد_گزارش_روزانه",
    "monthly": "#استراتژی‌واگرایی‌کارآمد_گزارش_ماهانه",
    "proximity_target": "#استراتژی‌واگرایی‌کارآمد_نزدیک_به_تارگت",
    "proximity_stop": "#استراتژی‌واگرایی‌کارآمد_نزدیک_به_استاپ",
    "order_request": "#استراتژی‌واگرایی‌کارآمد_درخواست_سفارش",
    "order_response": "#استراتژی‌واگرایی‌کارآمد_سفارش_ثبت_شد",
    "order_error": "#استراتژی‌واگرایی‌کارآمد_خطای_سفارش",
    "connection": "#استراتژی‌واگرایی‌کارآمد_اتصال_برقرار",
    "connection_change": "#استراتژی‌واگرایی‌کارآمد_تغییر_وضعیت_اتصال",
    "capital_reduced": "#استراتژی‌واگرایی‌کارآمد_سرمایه_کاهش_یافت",
}
